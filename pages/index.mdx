...
- **Open-source**: - Code can be viewed on Github at https://github.com/Mythic-Project/governance-ui
...
To create a DAO in Realms, a Solana wallet is required and a min. of **2 SOL** + network fees.
