...
<Callout type="info" emoji="ℹ️">
Realms supports standart SPL token program and token extensions. (**SPL & Token22**)
...
<Callout type="info" emoji="ℹ️">
Realms will set the type of max voter weight to "**Supply Fraction**" and set the circulating supply factor by "**1**" by default for SPL tokens, users can select which type of max voter weight they wanna use and also define the circulating supply factor under **`Advanced Options`** at this step in the Community Token **DAO** wizard.
</Callout>

<Callout type="warning" emoji="⚠️">
For token extensions (**Token22**), Realms will set the type of max voter weight to "**Absolute**" and set the circulating supply factor to the **number of tokens circulating** by default.
</Callout>
