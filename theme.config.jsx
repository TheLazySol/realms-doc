...
export default {
  ...
  navbar: {
    extraContent: (
      <>
        <a href="https://twitter.com/RealmsDAOs" target="_blank" rel="noopener noreferrer">
  ...
  banner: {
    key: '2.0-release',
    text: (
      <a href="https://discord.gg/6UZHcNJFr8" target="_blank">
  ...
  head: () => {
    ...
    return (
      <>
        ...
        <meta property="og:title" content={frontMatter.title || 'Realms'} />
        <meta
          property="og:description"
          content={frontMatter.description || 'The home for on-chain communities in the @Solana ecosystem.'}
        />
      </>
    );
  },
